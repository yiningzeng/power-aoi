...
const formSchema = addLocValues(require("./remoteTrainForm.json"));
// tslint:disable-next-line:no-var-requires
const uiSchema = addLocValues(require("./remoteTrainForm.ui.json"));
// const okTag: ITag = {
//     name: "OK",
//     color: "#FFFFF0",
// };
 ...
 */
export interface IProjectFormProps extends React.Props<RemoteTrainForm> {
    project: IProject;
 ...
 */
export default class RemoteTrainForm extends React.Component<IProjectFormProps, IProjectFormState> {
    private widgets = {
