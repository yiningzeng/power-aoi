...
import Login, { ILoginProps, ILoginState } from "./login";
...
describe("Homepage Component", () => {
    ...
    function createComponent(store, props: ILoginProps): ReactWrapper {
        return mount(
    ...
    it("should render a list of recent projects", () => {
        expect(wrapper).not.toBeNull();
        const homePage = wrapper.find(Login).childAt(0) as ReactWrapper<ILoginProps>;
    ...
    it("closes any open project and navigates to the new project screen", () => {
        ...
        const homepage = wrapper.find(Login).childAt(0) as ReactWrapper<ILoginProps, ILoginState>;
    ...
    function createProps(): ILoginProps {
        return {
            recentProjects: [],
