 ...
 */
export interface IAppSettingsProps extends RouteComponentProps, React.Props<AiTestSettingsPage> {
...
export default class AiTestSettingsPage extends React.Component<IAppSettingsProps> {
