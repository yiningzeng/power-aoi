...
const formSchema = addLocValues(require("./testSettingsForm.json"));
// tslint:disable-next-line:no-var-requires
const uiSchema = addLocValues(require("./testSettingsForm.ui.json"));

export interface IAppSettingsFormProps extends React.Props<TestSettingsForm> {
...
export class TestSettingsForm extends React.Component<IAppSettingsFormProps, IAppSettingsFormState> {
    private fields = {
